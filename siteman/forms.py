...
class WohnungRuambuchElektroModelForm(forms.ModelForm):
    def __init__(self, *args, **kwargs):
        ...
        self.fields['schalterprogramm'].widget.attrs.update(cols='80', rows='5')
        self.fields['tv_anschluss'].widget.attrs.update(cols='80', rows='5')
        self.fields['telefon_anschluss'].widget.attrs.update(cols='80', rows='5')
        self.fields['internet_anschluss'].widget.attrs.update(cols='80', rows='5')
    class Meta:
