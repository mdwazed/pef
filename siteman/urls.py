...
urlpatterns = [
    ...
    path('haus_hls', views.haus_hls, name='haus_hls'), 
    path('haus_hls_update/<int:pk>', views.HausHlsUpdateView.as_view(), name='haus_hls_update'),
    ...
    path('haus_turen', views.haus_turen, name='haus_turen'), 
    path('haus_turen_update/<int:pk>', views.HausTurenUpdateView.as_view(), name='haus_turen_update'),
    ...
    path('wohnung_turen', views.wohnung_turen, name='wohnung_turen'), 
    path('wohnung_turen_update/<int:pk>', views.WohnungTurenUpdateView.as_view(), name='wohnung_turen_update'),
